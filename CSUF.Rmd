...
as.data.frame(sent_nrc)
write_csv2(sent_nrc,"sent_nrc.csv")
write.csv(sent_nrc,'/Users/hbjursten/Desktop/sent_nrc.csv', row.names=T)
write_csv(sent_nrc, "sent_nrc.csv", row.names = F)
#~/Desktop/R Working Directory
